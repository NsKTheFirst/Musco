        ...
        <v-toolbar app class="black">
            ...
            <v-toolbar-items class="hidden-sm-and-down" >
                ...
                <v-menu offset-y transition="slide-y-transition" bottom>
                    <v-btn flat id="compteBtn" slot="activator" v-if="infos">Mon compte</v-btn>
                    <v-list v-if="infos">
                    ...
                    <v-btn flat id="connexionBtn" slot="activator" v-if="!infos">Connexion</v-btn> <!-- ajouter v-if="!infos" -->
                    <v-list v-if="!infos"> <!-- ajouter v-if="!infos" -->
